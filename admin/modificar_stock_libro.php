...
<body>
    ...
    <section id="sectionModificarLibroPhp">
        <div class="flexPrincipalModificarLibrosPhp" >
            ...
            <div class="cajaBusquedaStock">
            
            <p>Elija de que manera buscar el libro a reponer stock</p>
                ...
                <div class="subCajaBusquedaSelect">
                <p>Criterio especial</p>
                <p>(seleccione uno y pulse cargar)</p>
                <br>
                <p>Los 10...</p>
                    <div class="formulariosSelect">
                        <form method="post" action="../controllers/adminController.php">
